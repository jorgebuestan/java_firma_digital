...
import firmaxades.FirmaGenerica;
...
public class FirmasGenericasXAdES extends FirmaGenerica {
	  ...
	  public void ejecutarFirmaXades(String pathArchivoXMLFirmar, String pathDirectorioSalida, String nombreArchivoFirmado, Provider provider, X509Certificate certificado, PrivateKey privateKey, String tipo, long numero) throws ParserConfigurationException, SAXException, IOException {
	  ...
	  protected DataToSign createDataToSign() throws ParserConfigurationException, SAXException, IOException {
	    ...
	    datosAFirmar.addObject(new ObjectToSign((AbstractObjectToSign)new InternObjectToSign("comprobante"), "contenido comprobante", null, "text/xml", null));
